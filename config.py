...
API_ID = int(os.environ.get("API_ID", "31961410"))

# Your API Hash from my.telegram.org
API_HASH = os.environ.get("API_HASH", "84e16fd45e9ab928d4172e3d8d6d7906")

# Your Owner / Admin Id For Broadcast 
ADMINS = int(os.environ.get("ADMINS", "8163812423"))
...
CHANNEL_ID = os.environ.get("CHANNEL_ID", "8163812423")

# Your Mongodb Database Url
# Warning - Give Db uri in deploy server environment variable, don't give in repo.
DB_URI = os.environ.get("DB_URI", "mongodb+srv://jatinsalaria97_db_user:RewvYyM6MrjnLMQA@cluster0.dyhvhfq.mongodb.net/?appName=Cluster0") # Warning - Give Db uri in deploy server environment variable, don't give in repo.
